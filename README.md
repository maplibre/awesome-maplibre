...
- [mapbox-exif-layer](https://github.com/zwang-geog/mapbox-exif-layer) - Custom layers for wind particle animation and smooth weather rasters from EXIF-encoded JPEGs; supports MapLibre GL JS with globe projection [demo](https://www.mapbox-exif-layer.com/maplibre-gl-js-globe-projection-demo/index.html).
